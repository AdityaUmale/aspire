            ...
            <div className="space-y-6">
              ...
              <div className="inline-flex items-center gap-3 p-3 pl-0 rounded-2xl transition-all">
                ...
                <div className="flex flex-col">
                  <span className="font-serif text-2xl font-bold text-[#1a237e] leading-none tracking-tight">
                    Aspire Institute
                  </span>
                  <span className="text-[10px] font-sans font-bold uppercase tracking-[0.2em] text-[#3949ab] mt-1.5">
                    Human Development
                  </span>
                </div>
              </div>
