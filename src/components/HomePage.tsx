          ...
          <div className="container px-4 md:px-6 mx-auto">
            ...
            >
              {[
                ...
                { title: "Personality Development", tag: "For Everyone", description: "Unlock the best version of yourselves. It starts here", image: "/pdc-new/IMG_3805.jpg", slug: "/courses/personality-development", features: ["Self-confidence", "Communication skills", "Emotional intelligence", "Personal branding"] },
                ...
                { title: "Entrepreneurship Development", tag: "For Entrepreneurs", description: "Your Ideas deserve a plan. We help you build it.", image: "/edp/IMG_7496.JPG", slug: "/courses/entrepreneurship-development", features: ["Innovation", "Business planning", "Leadership", "Risk management"] },
                ...
                { title: "Corporate Training Programs", tag: "For Organisations", description: "Empowering People. Strengthening Organizations.", image: "/corporate-training/PHOTO-2026-07-17-12-58-14.jpg", slug: "/courses/corporate-training", features: ["Sales Training", "Leadership Development", "Team Communication", "Conflict Management"] },
              ].map((course, index) => (
                <Link
                  key={index}
                  href={course.slug}
