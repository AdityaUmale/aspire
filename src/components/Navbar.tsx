      ...
      <div className={`w-full max-w-7xl px-4 transition-all duration-300 ${scrolled ? 'py-2' : 'py-4 lg:py-6'}`}>
        ...
        <nav 
          className={`
            ...
            border border-white/40 shadow-[0_8px_30px_rgb(0,0,0,0.04)]
            transition-all duration-300 ease-in-out
            ${scrolled ? 'shadow-[0_8px_30px_rgb(26,35,126,0.08)]' : ''}
          `}
        >
          <div className="flex h-16 items-center justify-between px-4 lg:px-6">
            ...
            <div className="hidden md:flex items-center gap-1 z-10">
              ...
              <div className="relative articles-dropdown">
                <button
                  ...
                  className="relative px-4 py-2 text-sm font-sans font-medium text-gray-600 transition-all duration-300 hover:text-[#1a237e] group flex items-center gap-2"
                >
                  ...
                  <span className="absolute inset-0 rounded-lg bg-[#1a237e]/5 scale-90 opacity-0 transition-all duration-300 group-hover:scale-100 group-hover:opacity-100"></span>
                </button>
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl text-gray-500 hover:bg-[#1a237e]/5 hover:text-[#1a237e] transition-colors"
          ...
          <div
            ...
            `}
          >
            <div className="px-4 space-y-1 pt-2 border-t border-gray-100">
...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="relative px-4 py-2 text-sm font-sans font-medium text-gray-600 transition-all duration-300 hover:text-[#1a237e] group"
    >
...
function MobileNavLink({ href, onClick, children }: { href: string; onClick: () => void; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      onClick={onClick}
      className="flex items-center justify-between px-4 py-3 rounded-xl text-sm font-medium text-gray-600 hover:bg-[#f0f1fa] hover:text-[#1a237e] transition-all group"
    >
      <span>{children}</span>
