...
import { CheckCircle, GraduationCap, ArrowRight, Award } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6">
                  <GraduationCap className="h-4 w-4 text-[#c5cae9]" />
                  <span className="text-white/90 text-sm font-medium">Training Program</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                  <Link href="/#enquiry">
                    <button className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-[#1a237e] font-bold rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 w-full sm:w-auto">
                      <span>Become a Better Teacher</span>
              ...
              <div className="hidden md:block">
                <div className="relative group">
                  ...
                  <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl border border-[#e8eaf6] flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Training Excellence</p>
                      <p className="text-[#1a237e] font-bold">Be A Mentor</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            <div>
              ...
              <div className="prose prose-lg text-gray-700 leading-relaxed">
                <p className="mb-6">
                  Teachers are <span className="font-bold text-[#1a237e]">valuable assets</span> of modern society. We aim to develop typical teachers into proficient, resourceful and skillful educators through our training program.
                </p>
                <p>
                  Our research team has developed best-in-class training that helps teachers understand student psychology and use creative teaching methods. We equip you with modern pedagogical approaches and innovative classroom management strategies.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-20">
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 md:order-2">
                <h3 className="text-2xl md:text-3xl font-bold text-[#1a237e] mb-4">Modern Teaching Techniques</h3>
                <p className="text-gray-700 leading-relaxed text-lg mb-6">
                  Understand what makes classroom sessions more intriguing from the student perspective. Learn teaching techniques that can easily be applied in the classroom.
                </p>
                <p className="text-gray-700 leading-relaxed text-lg">
                  Develop into a quality teacher and help students learn more effectively. Become the mentor your students deserve.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Comprehensive training modules for teaching excellence.
            </p>
          </div>
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-[#c5cae9] text-base md:text-lg max-w-xl">
                    Empower yourself with modern teaching methods and become an exceptional educator.
                  </p>
                </div>
