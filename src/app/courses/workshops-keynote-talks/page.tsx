                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-lg md:text-xl text-[#c5cae9] mb-8 leading-relaxed max-w-lg mx-auto md:mx-0">
                                    Because the right two hours can rewrite the next twenty years. Aspire Institute&apos;s workshops are built to move you, challenge you, and leave you changed.
                                </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
                        <div>
                            ...
                            <div className="prose prose-lg text-gray-700 leading-relaxed">
                                <p className="mb-6">
                                    Because the right two hours can rewrite the next twenty years. Aspire Institute&apos;s workshops and talks are designed for exactly that: high-impact, focused sessions that cut straight to what matters.
                                </p>
                                <p className="mb-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <div className="order-2 md:order-1 relative">
                            ...
                            <div className="relative rounded-2xl overflow-hidden shadow-lg aspect-[4/3] transform rotate-0 hover:rotate-1 transition-transform duration-500">
                                <Image
                                    src="/workshop2.jpeg"
                                    alt="Audience engaged in an Aspire Institute workshop"
                                    fill
                                    className="object-cover"
                                />
                            </div>
