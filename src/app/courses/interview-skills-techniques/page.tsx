...
export default function InterviewSkillsTechniquesPage() {
    const courseOutline = [
        'Interview Prep + Real Mock Interviews',
        'Group Discussion Confidence',
        'Mindset Shift: Fear to Growth',
        'Honest Self-Branding & Communication',
        'Placement Readiness & Career Clarity',
    ];
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="text-center md:text-left">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6">
                                    ...
                                    <span className="text-white/90 text-sm font-medium">10 Days Transformation Program</span>
                                </div>
                            ...
                            <div className="hidden md:block">
                                <div className="relative group">
                                    ...
                                    <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                                        <Image
                                            src="/ist.jpg"
                                            alt="Interview Skills and Techniques Program"
                                            width={600}
                                            height={500}
                ...
                <div className="container mx-auto px-4 md:px-6 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-[#1a237e] mb-6 leading-tight">
                                Preparation for Real Opportunities
                            </h2>
                        ...
                        <div className="relative">
                            ...
                            <Image
                                src="/ist1.jpg"
                                alt="Interview skills training session"
                                width={600}
                                height={450}
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="order-1 md:order-2">
                            <h3 className="text-2xl md:text-3xl font-bold text-[#1a237e] mb-4">Claim Your Platform</h3>
            ...
            <section id="outline" className="py-20 md:py-28 bg-[#FAFAFA]">
                <div className="container mx-auto px-4 md:px-6 max-w-6xl">
                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                                ...
                                <div className="text-center lg:text-left">
                                    ...
                                    <p className="text-[#c5cae9] text-base md:text-lg max-w-xl">
                                        Discover your true potential and build the communication skills you&apos;ve always dreamed of. Become the best version of yourself.
                                    </p>
                                </div>
