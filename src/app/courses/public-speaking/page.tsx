          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            <div>
              ...
              <div className="prose prose-lg text-gray-700 leading-relaxed">
                <p className="mb-6">
                  Most adults struggle with fear, nervousness, or self-doubt when asked to speak in front of others, whether at work, in meetings, or on stage. Aspire Institute’s Public Speaking for Adults program is designed to transform that fear into confidence and clarity.
                </p>
                <p className="mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="prose prose-lg text-gray-700 leading-relaxed">
                ...
                <p className="mb-6">
                  Backed by Aspire Institute’s proven expertise and empowering methods, you won’t just learn to speak; you’ll learn to connect, influence, and lead with your words.
                </p>
