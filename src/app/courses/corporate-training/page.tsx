...
import { CheckCircle, ArrowRight, Award, Building2 } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6">
                  <Building2 className="h-4 w-4 text-[#c5cae9]" />
                  <span className="text-white/90 text-sm font-medium">Corporate Development</span>
                </div>
              ...
              <div className="hidden md:block">
                <div className="relative group">
                  ...
                  <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl border border-[#e8eaf6] flex items-center gap-3 animate-bounce-slow">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Customised Programs</p>
                      <p className="text-[#1a237e] font-bold">Result-Oriented</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            <div>
              ...
              <div className="prose prose-lg text-gray-700 leading-relaxed">
                <p className="mb-6">
                  In today&apos;s fast-changing business environment, an organization&apos;s greatest strength is its people. At Aspire – The Institute of Human Development, we design practical, engaging, and result-oriented corporate training programs that enhance professional skills, improve workplace relationships, and develop future-ready leaders.
                </p>
                <p className="mb-6">
                  Our training sessions combine interactive activities, real-life case studies, role plays, group discussions, and practical tools to ensure that learning is immediately applicable in the workplace. Whether your goal is to improve employee productivity, strengthen teamwork, enhance customer experience, or build effective leadership, our customized training solutions help individuals and organizations perform at their best.
                </p>
              </div>
            </div>
            <div className="relative">
              ...
              <Image
                src={introImage}
                alt="Corporate training session at Aspire Institute"
                width={600}
                height={450}
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="order-2 md:order-1 relative">
              ...
              <Image
                src={featureImage}
                alt="Corporate training programs for organizations"
                width={600}
                height={450}
            ...
            <div className="order-1 md:order-2">
              <h3 className="text-2xl md:text-3xl font-bold text-[#1a237e] mb-4">Our Corporate Training Programs</h3>
              <div className="prose prose-lg text-gray-700 leading-relaxed">
                <p className="mb-6">
                  Every organization has unique challenges. That&apos;s why our training programs are tailored to your industry, workforce, and business objectives, ensuring measurable improvements in performance, communication, and organizational growth.
                </p>
                <p className="font-bold text-[#1a237e] italic text-xl">
                  &ldquo;Building Skilled Professionals. Developing Exceptional Leaders. Transforming Organizations.&rdquo;
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="outline" className="py-20 md:py-28 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#1a237e] mb-4">Our Corporate Training Programs</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Practical, engaging programs tailored to strengthen skills, teams, and leadership across your organization.
            </p>
          </div>
